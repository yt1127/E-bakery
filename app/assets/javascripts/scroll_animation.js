...
$(function() {
  ...
  tl.add( TweenLite.fromTo(".grid-block-7", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }), "-=0.5");
  tl.add( TweenLite.fromTo(".grid-block-8", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }) );
  tl.add( TweenLite.fromTo(".grid-block-9", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }), "-=0.5");
  tl.add( TweenLite.fromTo(".grid-block-10", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }), "-=0.5");
  tl.add( TweenLite.fromTo(".grid-block-11", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }), "-=0.5");
  tl.add( TweenLite.fromTo(".grid-block-12", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }), "-=0.5");
  tl.add( TweenLite.fromTo(".grid-block-13", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }), "-=0.5");
  tl.add( TweenLite.fromTo(".grid-block-14", 1, {y:30,opacity:0 }, {ease: Power4.easeOut,y:0,opacity:1 }), "-=0.5");
